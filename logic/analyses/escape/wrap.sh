...
rm -rf $FACTS_DIR
java -cp $CLASSPATH doop.soot.Main -full -keep-line-number -use-original-names -application-only-facts -lsystem -application-regex $APPREGEX -allow-phantom -d $FACTS_DIR $JAR
