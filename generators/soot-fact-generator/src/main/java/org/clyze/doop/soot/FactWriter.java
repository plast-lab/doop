...
import static org.clyze.doop.common.JavaRepresentation.methodHandleConstant;
import static org.clyze.doop.common.PredicateFile.ANDROID_ENTRY_POINT;
import static org.clyze.doop.common.PredicateFile.APP_CLASS;
import static org.clyze.doop.common.PredicateFile.ARRAY_ALLOC;
import static org.clyze.doop.common.PredicateFile.ARRAY_ALLOC_CONST_SIZE;
import static org.clyze.doop.common.PredicateFile.ARRAY_INSN_INDEX;
import static org.clyze.doop.common.PredicateFile.ARRAY_NUM_INDEX;
import static org.clyze.doop.common.PredicateFile.ASSIGN_CAST;
import static org.clyze.doop.common.PredicateFile.ASSIGN_CAST_NULL;
import static org.clyze.doop.common.PredicateFile.ASSIGN_CAST_NUM_CONST;
import static org.clyze.doop.common.PredicateFile.ASSIGN_HEAP_ALLOC;
import static org.clyze.doop.common.PredicateFile.ASSIGN_INSTANCE_OF;
import static org.clyze.doop.common.PredicateFile.ASSIGN_NULL;
import static org.clyze.doop.common.PredicateFile.ASSIGN_NUM_CONST;
import static org.clyze.doop.common.PredicateFile.ASSIGN_PHANTOM_INVOKE;
import static org.clyze.doop.common.PredicateFile.ASSIGN_RETURN_VALUE;
import static org.clyze.doop.common.PredicateFile.BOOTSTRAP_PARAMETER;
import static org.clyze.doop.common.PredicateFile.BREAKPOINT_STMT;
import static org.clyze.doop.common.PredicateFile.CLASS_TYPE;
import static org.clyze.doop.common.PredicateFile.DIRECT_SUPER_CLASS;
import static org.clyze.doop.common.PredicateFile.DIRECT_SUPER_IFACE;
import static org.clyze.doop.common.PredicateFile.EMPTY_ARRAY;
import static org.clyze.doop.common.PredicateFile.ENTER_MONITOR;
import static org.clyze.doop.common.PredicateFile.EXIT_MONITOR;
import static org.clyze.doop.common.PredicateFile.FIELD_ANNOTATION;
import static org.clyze.doop.common.PredicateFile.FIELD_INITIAL_VALUE;
import static org.clyze.doop.common.PredicateFile.FIELD_MODIFIER;
import static org.clyze.doop.common.PredicateFile.FIELD_SIGNATURE;
import static org.clyze.doop.common.PredicateFile.GOTO;
import static org.clyze.doop.common.PredicateFile.INTERFACE_TYPE;
import static org.clyze.doop.common.PredicateFile.LOAD_ARRAY_INDEX;
import static org.clyze.doop.common.PredicateFile.LOAD_INST_FIELD;
import static org.clyze.doop.common.PredicateFile.LOAD_STATIC_FIELD;
import static org.clyze.doop.common.PredicateFile.LOOKUP_SWITCH;
import static org.clyze.doop.common.PredicateFile.LOOKUP_SWITCH_DEFAULT;
import static org.clyze.doop.common.PredicateFile.LOOKUP_SWITCH_TARGET;
import static org.clyze.doop.common.PredicateFile.METHOD_INV_LINE;
import static org.clyze.doop.common.PredicateFile.METHOD_MODIFIER;
import static org.clyze.doop.common.PredicateFile.NATIVE_RETURN_VAR;
import static org.clyze.doop.common.PredicateFile.NORMAL_HEAP;
import static org.clyze.doop.common.PredicateFile.PARAM_ANNOTATION;
import static org.clyze.doop.common.PredicateFile.PHANTOM_BASED_METHOD;
import static org.clyze.doop.common.PredicateFile.PHANTOM_METHOD;
import static org.clyze.doop.common.PredicateFile.POLYMORPHIC_INVOCATION;
import static org.clyze.doop.common.PredicateFile.RETURN;
import static org.clyze.doop.common.PredicateFile.RETURN_VOID;
import static org.clyze.doop.common.PredicateFile.SPECIAL_METHOD_INV;
import static org.clyze.doop.common.PredicateFile.STATIC_METHOD_INV;
import static org.clyze.doop.common.PredicateFile.STORE_ARRAY_INDEX;
import static org.clyze.doop.common.PredicateFile.STORE_INST_FIELD;
import static org.clyze.doop.common.PredicateFile.STORE_STATIC_FIELD;
import static org.clyze.doop.common.PredicateFile.STRING_RAW;
import static org.clyze.doop.common.PredicateFile.TABLE_SWITCH;
import static org.clyze.doop.common.PredicateFile.TABLE_SWITCH_DEFAULT;
import static org.clyze.doop.common.PredicateFile.TABLE_SWITCH_TARGET;
import static org.clyze.doop.common.PredicateFile.THROW;
import static org.clyze.doop.common.PredicateFile.THROW_NULL;
import static org.clyze.doop.common.PredicateFile.TYPE_ANNOTATION;
import static org.clyze.doop.common.PredicateFile.TYPE_SIMPLENAME;
import static org.clyze.doop.common.PredicateFile.UNSUPPORTED_INSTRUCTION;
import static org.clyze.doop.common.PredicateFile.VAR_SIMPLENAME;
import static org.clyze.doop.common.PredicateFile.VIRTUAL_METHOD_INV;
