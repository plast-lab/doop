...
public class AXmlAttribute<T> extends AXmlElement {
	...
	/**
	 * Creates a new {@link soot.jimple.infoflow.android.axml.AXmlAttribute} object with the given <code>name</code>, <code>value</code> and <code>namespace</code>.<br />
	...
	/**
	 * Creates a new {@link soot.jimple.infoflow.android.axml.AXmlAttribute} object with the given <code>name</code>, <code>value</code> and <code>namespace</code>.
	 *
	 * @param	name		the attribute's name.
	 * @param	resourceId	the attribute's resource id.
	 * @param	value		the attribute's value.
	...
	/**
	 * Creates a new {@link soot.jimple.infoflow.android.axml.AXmlAttribute} object with the given <code>name</code>,
