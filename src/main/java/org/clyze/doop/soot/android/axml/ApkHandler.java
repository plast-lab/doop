package org.clyze.doop.soot.android.axml;
...
public class ApkHandler {
	 ...
	 * the ZipFile is returned by {@link soot.jimple.infoflow.android.axml.ApkHandler#getInputStream(String)} the
	 ...
	 * @see		soot.jimple.infoflow.android.axml.ApkHandler#ApkHandler(File)
	 */
	...
	/**
	 * Creates a new {@link soot.jimple.infoflow.android.axml.ApkHandler} which handles the given APK file.
	 * 
	...
	/**
	 * Returns the absolute path of the APK which is held by the {@link soot.jimple.infoflow.android.axml.ApkHandler}.
	 * 
	...
	/**
	 * Returns the path of the APK which is held by the {@link soot.jimple.infoflow.android.axml.ApkHandler}.
	 * 
	 * @see		File#getPath()
	 */
	...
	/**
	 * Returns the filename of the APK which is held by the {@link soot.jimple.infoflow.android.axml.ApkHandler}.
	 * 
	 * @see		File#getName()
	 */
	 ...
	 * @throws	IOException		if an I/O error occurs.
	 * @see		{@link soot.jimple.infoflow.android.axml.ApkHandler#addFilesToApk(List, Map)}
	 */
	...
	/**
	 * Adds the files to the APK which is handled by this {@link soot.jimple.infoflow.android.axml.ApkHandler}.
	 * 
	 * @param	files			Array with File objects to be added to the APK.
