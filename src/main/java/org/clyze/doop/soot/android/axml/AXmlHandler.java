...
import org.clyze.doop.soot.android.axml.parsers.IBinaryXMLFileParser;
...
/**
 * {@link soot.jimple.infoflow.android.axml.AXmlHandler} provides functionality to parse a byte compressed android xml file and access all nodes.
 * 
...
public class AXmlHandler {
	...
	/**
	 * Contains the byte compressed xml which was parsed by this {@link soot.jimple.infoflow.android.axml.AXmlHandler}.
	 */
	protected byte[] xml;
	...
	/**
	 * Creates a new {@link soot.jimple.infoflow.android.axml.AXmlHandler} which parses the {@link InputStream}.
	 * 
