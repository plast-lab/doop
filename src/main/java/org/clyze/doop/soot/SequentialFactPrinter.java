...
/**
 * Created by anantoni on 26/10/2016.
 */
public class SequentialFactPrinter {
        ...
        SequentialFactPrinter(boolean ssa, boolean toStdout, String outputDir, PrintWriter writer, List<SootClass> sootClasses) {
            _ssa = ssa;
            _toStdout = toStdout;
