...
enum PredicateFile
{
    ...
    METHOD_DECL_EXCEPTION("Method_DeclaresException"),
    ...
    THIS_VAR("ThisVar"),
    EXCEPT_HANDLER_PREV("ExceptionHandler_Previous"),
    ...
    METHOD_INV_LINE("MethodInvocation_Line"),
    ...
    TABLE_SWITCH_TARGET("TableSwitch_Target"),
    TABLE_SWITCH_DEFAULT("TableSwitch_Default"),
    LOOKUP_SWITCH("LookupSwitch"),
    LOOKUP_SWITCH_TARGET("LookupSwitch_Target"),
    LOOKUP_SWITCH_DEFAULT("LookupSwitch_Default"),
    RETURN("Return"),
