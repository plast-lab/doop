...
enum PredicateFile
{
    ...
    FIELD_MODIFIER("_Field-Modifier"),
    FORMAL_PARAM("_FormalParam"),
    METHOD_DECL_EXCEPTION("_Method-DeclaresException"),
    METHOD_MODIFIER("_Method-Modifier"),
    NATIVE_RETURN_VAR("_NativeReturnVar"),
    VAR_TYPE("_Var-Type"),
    VAR_DECLARING_METHOD("_Var-DeclaringMethod"),
    APP_CLASS("_ApplicationClass"),
    THIS_VAR("_ThisVar"),
    EXCEPT_HANDLER_PREV("_ExceptionHandler-Previous"),
    ...
    METHOD_INV_LINE("_MethodInvocation-Line"),
    ...
    TABLE_SWITCH_TARGET("_TableSwitch-Target"),
    TABLE_SWITCH_DEFAULT("_TableSwitch-Default"),
    LOOKUP_SWITCH("_LookupSwitch"),
    LOOKUP_SWITCH_TARGET("_LookupSwitch-Target"),
    LOOKUP_SWITCH_DEFAULT("_LookupSwitch-Default"),
    RETURN("_Return"),
