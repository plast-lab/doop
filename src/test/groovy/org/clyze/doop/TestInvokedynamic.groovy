...
class TestInvokedynamic extends ServerAnalysisTests {
	...
	def "Server analysis test 107 (lambdas)"() {
		...
		then:
		varPointsToQ(analysis, '<Driver: void main(java.lang.String[])>/intWriter#_13', '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::apply/0::: java.util.function.Function::: (Mock)::: link object of type java.util.function.Function')
		linkObjectIsLambda(analysis, '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::apply/0::: java.util.function.Function::: (Mock)::: link object of type java.util.function.Function', '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::apply/0::: java.util.function.Function::: (Mock)::: reference Driver::lambda$main$0 from <Driver: java.lang.String lambda$main$0(java.lang.Integer)> wrapped as java.util.function.Function.apply')
		lambdaCGE(analysis, '<Driver: void main(java.lang.String[])>/java.util.function.Function.apply/0', '<Driver: java.lang.String lambda$main$0(java.lang.Integer)>')
	...
	def "Server analysis test 104 (method references)"() {
		...
		then:
		varPointsTo(analysis, '<Driver: void main(java.lang.String[])>/c1#_15', '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::accept/0::: java.util.function.Consumer::: (Mock)::: link object of type java.util.function.Consumer')
		linkObjectIsLambda(analysis, '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::accept/0::: java.util.function.Consumer::: (Mock)::: link object of type java.util.function.Consumer', '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::accept/0::: java.util.function.Consumer::: (Mock)::: reference A::meth1234 from <A: void meth1234(java.lang.Integer)> wrapped as java.util.function.Consumer.accept')
		varPointsTo(analysis, '<Driver: void main(java.lang.String[])>/c3#_52', '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::apply/2::: java.util.function.Function::: (Mock)::: link object of type java.util.function.Function')
		linkObjectIsLambda(analysis, '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::apply/2::: java.util.function.Function::: (Mock)::: link object of type java.util.function.Function', '<Driver: void main(java.lang.String[])>/invokedynamic_metafactory::apply/2::: java.util.function.Function::: (Mock)::: reference A::meth99 from <A: java.lang.Integer meth99(java.lang.Integer)> wrapped as java.util.function.Function.apply')
		varPointsTo(analysis, '<A: void meth1234(java.lang.Integer)>/x#_0', '<Driver: void main(java.lang.String[])>/new java.lang.Integer/0')
		varPointsTo(analysis, '<A: java.lang.Integer meth99(java.lang.Integer)>/this#_0', '<Driver: void main(java.lang.String[])>/new A/0')
		lambdaCGE(analysis, '<Driver: void main(java.lang.String[])>/java.util.function.Supplier.get/1', '<A: void <init>()>')
		varPointsTo(analysis, '<A: void <init>()>/@this', 'mock A constructed by constructor reference at <Driver: void main(java.lang.String[])>/java.util.function.Supplier.get/1')
	...
	def "Server analysis test 115 (invokedynamic, method handles/types)"() {
		...
		then:
		varPointsTo(analysis, '<Driver: void test1()>/println2out#_31', '<direct method handle for <java.io.PrintStream: void println(java.lang.String)>>')
		varPointsTo(analysis, '<Driver: void test2()>/methV_mh#_39', '<direct method handle for <A: void methV()>>')
		varPointsTo(analysis, '<Driver: void test3()>/methI_mh#_49', '<direct method handle for <A: void methI(java.lang.Integer)>>')
		varPointsTo(analysis, '<Driver: void test4()>/methDD_mh#_58', '<direct method handle for <A: java.lang.Double doubleIdentity(java.lang.Double)>>')
	}
}
