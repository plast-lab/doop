...
class TestLambdasMethodReferences extends DoopSpec {
	...
	def "Server analysis test 107 (lambdas)"(String analysisName, boolean wala) {
		...
		then:
		println "Feature: Creating lambdas with arrow notation."
	...
	def "Server analysis test 104 (method references)"(String analysisName) {
		...
		println "Feature: Construction of functional objects directly from method references."
		...
		println "Feature: Use of functional objects together with Java 8 stream API methods."
		...
		println "Feature: instance method references."
		...
		println "Feature: static method reference (Person::compareByAge)."
		...
		println "Feature: instance method reference that captures receiver (myComparisonProvider::compareByName)."
		...
		println "Feature: instance method reference that does not capture receiver (String::compareToIgnoreCase)."
		...
		println "Feature: constructor references."
