...
PRE_ANALYSIS_2 = '2-type-sensitive+heap'
...
def run_pre_analyses(init_args, app):
    ...
    print(cmd)
    os.system(cmd)
    two_obj_analysis_database = os.path.join(DOOP_OUT, '2-type-sensitive+heap', app+'-2type', 'database')
    two_obj_analysis_facts = os.path.join(DOOP_OUT, '2-type-sensitive+heap', app+'-2type', 'facts')
